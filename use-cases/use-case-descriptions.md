...
2. Το σύστημα εκκινεί το chatbot στην σελίδα αλληλεπίδρασης με το bot.
...
5. Το σύστημα εφαρμόζει NLP processing - μετατρέπει το κείμενο σε πεζά γράμματα, αφαιρεί τα σημεία στίξης και τα stopwords.
6. Το σύστημα συγκρίνει το επεξεργασμένο ερώτημα με keywords η φράσεις που έχουν οριστεί στην βάση.
7. Το σύστημα εντοπίζει συμφωνία με κάποια εγγραφή και ανακτά την αντίστοιχη απάντηση από την ΒΔ.
8. Το σύστημα μορφοποιεί την απάντηση και αποστέλλεται στο χρήστη μέσω του chatbot.
