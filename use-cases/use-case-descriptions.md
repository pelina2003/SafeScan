...
- Πρέπει να υπάρχει ένα αρχείο με δεδομένα γνώσης για το chatbot.
...
9. Το σύστημα αναζητά την πρόθεση που προβλέφθηκε στα δεδομένα γνώσης του chatbot την εντοπίζει και επιλέγει τυχαία μια απο τις διαθέσιμες απαντησεις για την δεδομένη πρόθεση.
...
9.1 Το σύστημα δεν εντοπίζει την πρόθεση που προβλέφθηκε και επιλέγει ένα μοτίβο τυχαία απο τα δεδομένα γνώσεων.
...
3.1 Το σύστημα εντοπίζει οτι υπάρχει ήδη εκπαιδευμένο μοντέλο για τα δεδομένα γνώσης του chatbot και την φορτώνει.
