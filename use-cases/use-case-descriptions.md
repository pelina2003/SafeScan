...
- Η βάση γνώσεων πρέπει να είναι διαθέσιμη και λειτουργική.
...
4. Το σύστημα εφαρμόζει NLU - tokenization,μετατροπή κειμένου σε πεζά γράμματα, αφαίρεση σημείων στίξης και stopwords καθώς και λημματοποίηση.
5. Το σύστημα μετατρέπει τα παραπάνω επεξεργασμένα μοτίβα σε διανύσματα και εκπαιδεύει το μοντέλο να συνδέει τις προθέσεις με μοτίβα κειμένων.
6. Το σύστημα εκτυπώνει μήνυμα καλωσορίσματος στην σελίδα αλληλεπίδρασης με το chatbot.
7. Ο χρήστης εισάγει την ερώτηση του.
8. Το σύστημα επεξεργάζεται την είσοδο του χρήστη εφαρμόζοντας NLU και μετατρέποντας τη σε διάνυσμα προβλέποντας στο τέλος την πρόθεση της εισόδου.
9. Το σύστημα αναζητά την πρόθεση που προβλέφθηκε στα δεδομένα γνώσης του chatbot, επιλέγοντας τυχαία μια απο τις διαθέσιμες απαντησεις για την δεδομένη πρόθεση.
10. Το σύστημα εκτυπώνει την απάντηση στην σελίδα αλληλεπίδρασης με το chatbot και περιμένει νέα ερώτηση απο τον χρήστη. 


**Εναλλακτική Ροή 1** Μη αναγνωρίσιμη ερώτηση από τον χρήστη

7.1 Το σύστημα δεν εντοπίζει αντιστοίχιση της ερώτησης με κάποιο γνωστό intent ή κανόνα.

7.2 Το σύστημα αυξάνει τον μετρητή αποτυχίας ελέγχοντας οτι είναι μικρότερος από έναν προκαθορισμένο αριθμό.

7.3 Το σύστημα ενεργοποιεί fallback μηχανισμό - προβάλλοντας ένα μήνυμα αποτυχίας και προτρέποντας τον χρήστη να επαναδιατυπώσει την ερώτηση του.

Το use case συνεχίζει από το βήμα 4.

**Εναλλακτική Ροή 2** Πολλαπλές αποτυχίες αναγνώρισης intent ή κανόνων

7.2.1 Το σύστημα αυξάνει τον μετρητή αποτυχίας ελέγχοντας οτι είναι μεγαλύτερος ή ίσος από έναν προκαθορισμένο αριθμό.

7.2.2 Το σύστημα ενεργοποιεί fallback μηχανισμό - προβάλλοντας ένα μήνυμα αποτυχίας και προτρέποντας τον χρήστη να συνδεθεί με ανθρώπινη υποστήριξη.
