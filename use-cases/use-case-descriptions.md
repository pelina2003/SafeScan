...
2. Το σύστημα εκκινεί το chatbot ανοίγοντας το στην σελίδα αλληλεπίδρασης με το bot.
3. Το σύστημα προβάλλει μήνυμα καλωσορίσματος και καλεί τον χρήστη να εισάγει την ερώτηση του.
4. Ο χρήστης πληκτρολογεί ένα ερώτημα.
5. Το σύστημα εφαρμόζει NLP processing - tokenization,μετατροπή κειμένου σε πεζά γράμματα, αφαίρεση σημείων στίξης και stopwords.
6. Το σύστημα συγκρίνει το επεξεργασμένο ερώτημα με κανόνες (regex patterns) από τη βάση γνώσης, ώστε να εντοπίσει το σχετικό intent.
7. Το σύστημα εντοπίζει συμφωνία με κάποια εγγραφή και ανακτά την αντίστοιχη απάντηση από την ΒΔ.
8. Το σύστημα μορφοποιεί την απάντηση αντικαθιστώντας δυναμικά στοιχεία , αφαιρώντας περιττά σύμβολα και προσαρμόζοντας τη γλώσσα.
9. Το σύστημα αποστέλλει την μορφοποιημένη απάντηση στον χρήστη. 
